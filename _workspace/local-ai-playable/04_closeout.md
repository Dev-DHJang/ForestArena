...
- 나비 약공격 2단 r01 시트와 순서 비교 재생 HTML을 추가했다. 미승인 시안이며, 발 높이·여백·동작 연속성은 추가 검토가 필요하다. 미리보기의 브라우저 직접 재생은 보안 정책 때문에 미확인으로 남겼다. 1단 승인이나 이번 생성만으로 2단을 runtime에 등록하지 않는다.
