...
godot --headless --path . --script res://tests/phase5_job_growth.gd
godot --headless --path . --script res://tests/phase5_runtime_behavior.gd
godot --headless --path . --script res://tests/phase5_telemetry.gd
godot --headless --path . --script res://tests/frame_performance_recorder.gd
...
echo "Forest Arena Phase 3 defense/evade verification passed."
